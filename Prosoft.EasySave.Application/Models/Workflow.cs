...
{
    public static async Task<T> StartAsync<T>(this Task<JobResult> tasks, ExecutionType executionType, CancellationToken cancellationToken = default) where T : class
    {
